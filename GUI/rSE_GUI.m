function [rse]=rSE_GUI(IsNorm,fileSource,pathSource,fileTarget,pathTarget)
...
It=imread(filenameT); It = im2double(It);
targ=load(pathTarget+"punti_target.mat");
sour=load(pathSource+"punti_"+fileSource(1:end-4)+".mat");
